(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cmn-utils"] = factory();
	else
		root["cmn-utils"] = factory();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__request__ = __webpack_require__(14);
...
var L = function L() {
  __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, L);
};

// Request 函数


for (var r in __WEBPACK_IMPORTED_MODULE_1__request__) {
  L[r] = __WEBPACK_IMPORTED_MODULE_1__request__[r];
}

// Utils 函数
for (var u in __WEBPACK_IMPORTED_MODULE_2__utils__) {
  L[u] = __WEBPACK_IMPORTED_MODULE_2__utils__[u];
}

// Store 函数
for (var s in __WEBPACK_IMPORTED_MODULE_3__store__) {
  L[s] = __WEBPACK_IMPORTED_MODULE_3__store__[s];
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__request__ = __webpack_require__(15);
...
var Request = function () {
   ...
   * @return {Request}
   */
  Request.prototype.config = function config(key, value) {
  ...
  Request.prototype.headers = function headers(key, value) {
    var headers = this._options.headers;
  ...
  Request.prototype.contentType = function contentType(type) {
    var headers = this._options.headers;
  ...
  Request.prototype._data = function _data(data, contentType) {
    var body = null;
  ...
  this.send = function (url) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var beforeRequest = options.beforeRequest,
          ...
          fetchOpts = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties___default()(options, ['beforeRequest', 'afterResponse', 'responseType', 'prefix']);

      var contentType = fetchOpts.headers['content-type'];
      ...
      return fetch(prefix + url, fetchOpts).then(function (response) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["setStore"] = setStore;
/* harmony export (immutable) */ __webpack_exports__["getStoreAsync"] = getStoreAsync;
/* harmony export (immutable) */ __webpack_exports__["getStore"] = getStore;
/* harmony export (immutable) */ __webpack_exports__["getStoreInfo"] = getStoreInfo;
/* harmony export (immutable) */ __webpack_exports__["removeStore"] = removeStore;
/* harmony export (immutable) */ __webpack_exports__["clearStore"] = clearStore;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern__);
...
function setStore(key, value) {
  if (Object(__WEBPACK_IMPORTED_MODULE_1__utils__["isObject"])(key)) {
    for (var k in key) {
      __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default.a.set(k, key[k]);
    }
  } else {
    __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default.a.set(key, value);
  }
  return this;
}
 ...
 * @return {Promise}
 */
function getStoreAsync(key) {
  return Promise.resolve(__WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default.a.get(key));
}
...
function getStore(key) {
  return __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default.a.get(key);
}
...
function getStoreInfo() {
  var db = [];
  __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default.a.each(function (value, key) {
    var _db$push;

    db.push((_db$push = {}, _db$push[key] = value, _db$push));
  });
  return db;
}
...
function removeStore(key) {
  __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default.a.remove(key);
  return this;
}
 ...
 */
function clearStore() {
  __WEBPACK_IMPORTED_MODULE_0_store_dist_store_modern___default.a.clearAll();
}
...
var engine = __webpack_require__(49)
...
//# sourceMappingURL=cmn-utils.js.map